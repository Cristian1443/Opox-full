...
export function buildContainer() {
    ...
    const useCases = {
        ...
        getMockProgress: new GetMockProgressUseCase(trainingRepo),
        clearMockProgress: new ClearMockProgressUseCase(trainingRepo),
        saveLawView: new SaveLawViewUseCase(trainingRepo),
        getLastLawView: new GetLastLawViewUseCase(trainingRepo),
        ...
        reportQuestion: new ReportQuestionUseCase(trainingRepo),
        rateQuestion: new RateQuestionUseCase(trainingRepo),
        ...
        getBoeMiniTest: new GetBoeMiniTestUseCase(boeRepo, aiApi, motorBoe, env.MOTOR_BOE_CURSO_ID ?? null),
        answerBoeMiniTest: new AnswerBoeMiniTestUseCase(motorBoe),
    ...
    const trainingController = new TrainingController({
        ...
        rateQuestion: useCases.rateQuestion,
        saveMockProgress: useCases.saveMockProgress,
        getMockProgress: useCases.getMockProgress,
        clearMockProgress: useCases.clearMockProgress,
        saveLawView: useCases.saveLawView,
        listTopics: useCases.listTopics,
    ...
    const boeController = new BoeController({
        ...
        answerMiniTest: useCases.answerBoeMiniTest,
